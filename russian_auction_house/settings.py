...
SECRET_KEY = 'django-insecure-z75p=*2a+1(!wah3^!1d_zcgiklcfiq5-@ra*=dek%^fg_2@cl'
...
WSGI_APPLICATION = 'russian_auction_house.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'russian_auction_house',
        'USER': 'russian_auction_houseadmin',
        'PASSWORD': 'russian_auction_housesecret',
        'HOST': 'localhost',
        'PORT': '',
    }
}
